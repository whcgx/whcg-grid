...
describe('selection', () => {
  ...
  it('should bind to cells', () => {
    ...
    expect(cells[0]._instance.selected).to.be.true;
    expect(cells[1]._instance.selected).to.be.true;
    expect(getRowCells(rows[1])[0]._instance.selected).to.be.false;
  });

  it('should reflect cell instance value', () => {
    const cells = getRowCells(rows[0]);
