  ...
  describe('generic operations', () => {
    ...
    describe('columns inside group', () => {
      ...
      it('should support removing late', done => {
        const column = dom(firstGroup).querySelector('vaadin-grid-column');
        dom(firstGroup).removeChild(column);
        flush$0();
    ...
    describe('groups inside grid', () => {
      ...
      it('should support removing late', done => {
        const group = dom(grid).querySelector('vaadin-grid-column-group');
        dom(grid).removeChild(group);
        flush$0();
    ...
    describe('groups inside group', () => {
      ...
      beforeEach(() => {
        ...
        init('nested-groups');
        firstGroup = dom(grid).querySelector('vaadin-grid-column-group');
      });
      ...
      it('should support removing late', done => {
        const group = dom(firstGroup).querySelector('vaadin-grid-column-group');
        dom(firstGroup).removeChild(group);
        flush$0();
    ...
    function shouldSupportEffectiveChildren(inGroup) {
      describe('children mutations', () => {
        describe('with columns', () => {
          ...
          it('should support adding late', done => {
            ...
            const column = fixture('column');
            dom(column).setAttribute('slot', inGroup ? 'group' : 'grid');
            dom(wrapper).insertBefore(column, dom(wrapper).firstChild);
            flush$0();
          ...
          it('should support removing late', done => {
            const column = dom(wrapper).querySelector('vaadin-grid-column');
            dom(wrapper).removeChild(column);
            flush$0();
        ...
        describe('with groups', () => {
          ...
          beforeEach(() => {
            ...
            firstGroup = dom(wrapper).querySelector('vaadin-grid-column-group');
          });
          ...
          it('should support adding late', done => {
            const group = fixture('group');
            dom(group).setAttribute('slot', inGroup ? 'group' : 'grid');
            dom(wrapper).insertBefore(group, dom(wrapper).firstChild);
            flush$0();
          ...
          it('should support removing late', done => {
            dom(wrapper).removeChild(firstGroup);
            flush$0();
      ...
      describe('nested group mutations', () => {
        ...
        describe('with groups', () => {
          it('should support adding late', done => {
            const group = fixture('group');
            dom(firstGroup).insertBefore(group, dom(firstGroup).firstChild);
            flush$0();
