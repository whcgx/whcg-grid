...
<body>
  ...
  <test-fixture id="onecolumnonegroup">
    <template>
      <vaadin-grid size="10">
...
describe('column groups', () => {
  ...
  describe('1 column 1 group', () => {
    ...
    beforeEach(() => {
      ...
      init('onecolumnonegroup');

      extraColumn = document.importNode(document.querySelector('#extra').content, true)
        .querySelector('vaadin-grid-column');
    ...
    it('should have visible footer rows after adding extra column', () => {
      dom(grid).appendChild(extraColumn);
      flushGrid(grid);
    ...
    it('should not have visible footer rows after removing extra column', () => {
      dom(grid).appendChild(extraColumn);
      flush$0();
      dom(grid).removeChild(extraColumn);
      flush$0();
  ...
  describe('Nested groups', () => {
    ...
    it('should have cell content wrappers in all header cells', () => {
      dom(header).querySelectorAll('[part~="cell"]').forEach(a => {
    ...
    it('should have cell content wrappers in all footer cells', () => {
      dom(footer).querySelectorAll('[part~="cell"]').forEach(a => {
        const content = getCellContent(a);
        expect(content.localName).to.equal('vaadin-grid-cell-content');
      });
    });
